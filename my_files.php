...
$result = $mysqli->query("SELECT * FROM files WHERE uploaded_by = $user_id ORDER BY uploaded_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="sidebar">
    ...
    <a href="my_files.php" class="active"><i class="fa fa-folder"></i> My Files</a>
...
<div class="main">
    <h3 class="fw-bold mb-3">My Files</h3>
    <div class="card-box">
