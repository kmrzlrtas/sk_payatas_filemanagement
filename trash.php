...
$result = $mysqli->query("SELECT * FROM files WHERE filepath LIKE '%trash%' ORDER BY uploaded_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Trash | SK FileHub</title>
...
<div class="sidebar">
    ...
    <a href="trash.php" class="active"><i class="fa fa-trash"></i> Trash</a>
...
<div class="main">
    ...
    <div class="card-box">
        <?php if ($result->num_rows > 0): while($file = $result->fetch_assoc()): ?>
            <div class="file-item">
                <div><i class="fa fa-trash text-danger me-2"></i><?= htmlspecialchars($file['filename']) ?></div>
